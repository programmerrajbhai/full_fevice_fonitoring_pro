...
const Color kPrimaryColor = Color(0xFF00FF00); // Neon Green (Hacker style)
const Color kCardColor = Color(0xFF111111);
...
const String kAdminKey = "ADMIN123"; // এই কি (Key) টি মিললে কাজ হবে